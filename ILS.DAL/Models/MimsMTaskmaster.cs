...
{
    public partial class MimsMTaskmaster
    {
        public MimsMTaskmaster()
        {
            MimsMEswbspms = new HashSet<MimsMEswbspms>();
            MimsRRequsition = new HashSet<MimsRRequsition>();
        }
        ...
        public virtual MimsMDoccat DocNoNavigation { get; set; }
        ...
        public virtual ICollection<MimsRRequsition> MimsRRequsition { get; set; }
    }
}
